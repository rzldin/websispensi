<section class="row">
	<div class="col-sm-12">
		<section class="row">
			<div class="col-12">
				<h3 class="mb-4"><i class="fa fa-info-circle"></i> Info Kategori</h3>
			</div>
			<div class="col-lg-4 mb-4 bg-default">
				<div class="card">
					<div class="card-header">Kategori Artificial Intelegent</div>
			...
			<div class="col-lg-4 mb-4 bg-default">
				<div class="card">
					<div class="card-header">Kategori Rekayasa Perangkat Lunak</div>
					<div class="card-block">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
						   ut ante in sapien blandit luctus sed ut lacus. Phasellus urna est, faucibus
						   nec ultrices placerat, feugiat et ligula. Donec vestibulum magna a dui
			...
			<div class="col-lg-4 mb-4 bg-default">
				<div class="card">
					<div class="card-header">Kategori Jaringan</div>
					<div class="card-block">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
						   ut ante in sapien blandit luctus sed ut lacus. Phasellus urna est, faucibus
						   nec ultrices placerat, feugiat et ligula. Donec vestibulum magna a dui
