                 ...
                 <?php foreach ($proposal as $pro ) : ?>
                    ...
                    <form class="form" action="<?php echo base_url('administrator/penjadwalan/jadwal_sempro_aksi')?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" name="nama_hari" id="nama_hari" value="<?php echo set_value('nama_hari')?>" class="form-control datepicker" placeholder="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Waktu Mulai</label>
                        <div class="col-md-9">
                          <input type="time" name="waktu_mulai" id="waktu_mulai" value="<?php echo set_value('waktu_mulai')?>" class="form-control" placeholder="" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Waktu Berakhir</label>
                        <div class="col-md-9">
                          <input type="time" name="waktu_akhir" id="jam" value="<?php echo set_value('waktu_akhir')?>" class="form-control" placeholder="" required>
                        </div>
                      </div>
                      <div class="form-group row">
