<div class="container-fluid">
	<div class="alert alert-success" role="alert">
		<i class="fas fa-university"></i> DAFTAR JADWAL SEMPRO
	</div>
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary"><a href="<?php echo base_url('administrator/mahasiswa')?>" style="text-decoration: none;">Data Jadwal Sempro</a></h6><br>
         <a class="btn btn-danger" href="<?php echo base_url('administrator/auth/pdf')?>"><i class="fa fa-print"></i> Export PDF</a>
        </div>
